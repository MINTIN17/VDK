...
void setup() {
  ...
  server.on("/", [] {
    server.send(200, "text/html",
                ...
                "function quaydongco(deg){"
                "var degreesInput = document.getElementById('degrees');"
                "degreesInput.value = deg;"
                ...
                "<br>"
                "<br>"
                "<button style='margin-right:30px' onclick = quaydongco(30) >30 deg</button>"
                "<button style='margin-right:30px' onclick = quaydongco(60) >60 deg</button>"
                "<button style='margin-right:30px' onclick = quaydongco(90) >90 deg</button>"
                "<button style='margin-right:30px' onclick = quaydongco(180) >180 deg</button>"
                "</body>"
